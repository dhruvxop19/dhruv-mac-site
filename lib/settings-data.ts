...
export const accountInfo = {
  name: "Dhruv",
  initials: "DG",
  email: "dhruv.gadiya@icloud.com",
  avatarPath: "/dhruv-about.jpg",
  appleId: "dhruv.gadiya@icloud.com",
  device: "Dhruv's MacBook Air",
  birthday: "February 22, 2006",
  twitterHandle: "StackDhruv",
  twitterUrl: "https://x.com/StackDhruv",
};
...
export const appleDevices = [
  { name: "Dhruv's MacBook Air", subtitle: "This MacBook Air M5", type: "mac" as const },
  { name: "Dhruv's iPhone", subtitle: "iPhone 14 Pro", type: "iphone" as const },
  { name: "Dhruv's Apple Watch", subtitle: "Apple Watch Series 10", type: "watch" as const },
];

export const wifiInfo = {
  networkName: "FBI Surveillance Van",
  ...
  secured: false,
  hotspotName: "Dhruv's iPhone",
  knownNetworks: ["FBI Surveillance Van"],
};

export const bluetoothDevices = [
  { name: "ZEB-SHEER B", status: "Connected" as const, battery: "62%", type: "headset" },
  { name: "Dhruv's AirPods Pro", status: "Not Connected" as const, battery: null, type: "headphones" },
  { name: "Dhruv's AirPods Pro 2", status: "Not Connected" as const, battery: null, type: "headphones" },
  { name: "Dhruv's Apple Watch", status: "Not Connected" as const, battery: null, type: "watch" },
  ...
  { name: "Dhruv's Buds Air 5 Pro", status: "Not Connected" as const, battery: null, type: "headset" },
