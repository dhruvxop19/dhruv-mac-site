...
const ART = {
  ...
  nativeDeluxe:
    "https://is1-ssl.mzstatic.com/image/thumb/Music126/v4/25/46/a7/2546a71a-b2bb-b4c9-4c52-a4daa3ae23ca/13UMGIM15076.rgb.jpg/100x100bb.jpg",
  worldSideMoonDeluxe:
    "https://is1-ssl.mzstatic.com/image/thumb/Music122/v4/9a/72/eb/9a72eb50-97ad-9684-8f3b-46587ef81ac2/12UMGIM56926.rgb.jpg/100x100bb.jpg",
  scorpion:
    "https://is1-ssl.mzstatic.com/image/thumb/Music115/v4/bb/6d/8f/bb6d8f67-6d04-10b5-dd62-eb5809ac54fc/00602567879152.rgb.jpg/100x100bb.jpg",
  divideDeluxe:
  ...
  testing:
    "https://is1-ssl.mzstatic.com/image/thumb/Music115/v4/d3/91/9c/d3919c54-3426-07a2-91a4-b4e46b2a8d34/886447076453.jpg/100x100bb.jpg",
...
export const songs: Song[] = [
  {
    ...
    artist: "OneRepublic",
    albumId: "native-deluxe",
    albumTitle: "Native (Deluxe)",
    artworkUrl: art(ART.nativeDeluxe),
    previewUrl:
  ...
  },
  {
    ...
    albumId: "world-side-moon-deluxe",
    albumTitle: "The World From the Side of the Moon (Deluxe Version)",
    artworkUrl: art(ART.worldSideMoonDeluxe),
    previewUrl:
      "https://audio-ssl.itunes.apple.com/itunes-assets/AudioPreview211/v4/a8/68/21/a86821f1-cf17-28df-f335-9e0d2884c966/mzaf_17505643041428239677.plus.aac.p.m4a",
    durationMs: 209695,
    trackNumber: 3,
  },
  {
    ...
    albumId: "scorpion",
    albumTitle: "Scorpion",
    artworkUrl: art(ART.scorpion),
    previewUrl:
      "https://audio-ssl.itunes.apple.com/itunes-assets/AudioPreview115/v4/da/7d/f1/da7df14b-8ee6-5020-d850-ccc0381eb141/mzaf_5511967710095380808.plus.aac.p.m4a",
    durationMs: 198973,
    trackNumber: 5,
  },
  {
    ...
    title: "Galway Girl",
    artist: "Ed Sheeran",
    albumId: "divide-deluxe",
    albumTitle: "÷ (Deluxe)",
    artworkUrl: art(ART.divideDeluxe),
    previewUrl:
      "https://audio-ssl.itunes.apple.com/itunes-assets/AudioPreview211/v4/26/98/fc/2698fc53-3774-bd3c-8b22-f1f845eacdaf/mzaf_11930414004759637913.plus.aac.p.m4a",
    durationMs: 170827,
    trackNumber: 6,
  },
  {
    ...
    albumId: "testing",
    albumTitle: "TESTING",
    artworkUrl: art(ART.testing),
    previewUrl:
      "https://audio-ssl.itunes.apple.com/itunes-assets/AudioPreview125/v4/8f/7b/c9/8f7bc926-4b40-a20c-09c2-6b368d4b5d8b/mzaf_6377849716329792033.plus.aac.p.m4a",
    durationMs: 205813,
    trackNumber: 5,
  },
  {
    ...
    artworkUrl: art(ART.worldSideMoonDeluxe),
    previewUrl:
      "https://audio-ssl.itunes.apple.com/itunes-assets/AudioPreview211/v4/af/35/1d/af351d37-3a0f-250c-3c67-2f491de797fe/mzaf_1342183238559671109.plus.aac.p.m4a",
    durationMs: 210172,
    trackNumber: 2,
  },
...
export const albums: Album[] = [
  ...
  {
    id: "world-side-moon-deluxe",
    title: "The World From the Side of the Moon (Deluxe Version)",
    artist: "Phillip Phillips",
    artistId: "phillip-phillips",
    year: 2012,
    artworkUrl: art(ART.worldSideMoonDeluxe),
    genre: "Pop",
    songIds: ["1440862440", "1440862445"],
  },
  {
    id: "scorpion",
    title: "Scorpion",
...
export const artists: Artist[] = [
  {
    ...
    name: "OneRepublic",
    artworkUrl: art(ART.nativeDeluxe),
    albumIds: ["native-deluxe"],
  },
  {
    id: "phillip-phillips",
    name: "Phillip Phillips",
    artworkUrl: art(ART.worldSideMoonDeluxe),
    albumIds: ["world-side-moon-deluxe"],
  },
  {
    id: "drake",
    name: "Drake",
...
export const frequentlyPlayedIds: string[] = [
  ...
  "1440862445", // Gone, Gone, Gone — Phillip Phillips
  "1406109863", // God's Plan — Drake
  "1193701436", // Galway Girl — Ed Sheeran
  "1388566993", // Praise The Lord (Da Shine) — A$AP Rocky
  "1440862440", // Home — Phillip Phillips
];
...
export const homeFeatured: Array<{
  ...
  { label: "No. 1", title: "Native (Deluxe)", accent: "dark", albumId: "native-deluxe" },
  { label: "Comfort", title: "The World From the Side of the Moon", accent: "blue", albumId: "world-side-moon-deluxe" },
  { label: "Energy", title: "Scorpion", accent: "pink", albumId: "scorpion" },
  { label: "Loop", title: "÷ (Deluxe)", accent: "green", albumId: "divide-deluxe" },
];
